...
$config = [
    ...
    'components' => [
        'request' => [
            ...
            'cookieValidationKey' => 'PaRWqcN_VB69lkpLmeVxoV5mOyYC8R-V',
        ],
        'cache' => [
        ...
        'urlManager' => [
            ...
            'rules' => [
                ['class' => 'yii\rest\UrlRule', 'controller' => 'v1/buku'],
                ['class' => 'yii\rest\UrlRule', 'controller' => 'v1/chapter'],
                ['class' => 'yii\rest\UrlRule', 'controller' => 'v1/kuis'],
                ['class' => 'yii\rest\UrlRule', 'controller' => 'v1/user'],
                ['class' => 'yii\rest\UrlRule', 'controller' => '/pola'],
            ],
        ],
        'view' => [
